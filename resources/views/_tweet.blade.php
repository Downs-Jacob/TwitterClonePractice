    ...
    <div>
        ...
        <div class="flex">
            <div class="flex items-center mb-3 mr-3">
                <svg viewBox="0 0 20 20" class="w-3 mr-1 text-gray-500">
                ...
                <span class="text-xs text-gray-300">{{ $tweet->likes }}</span>
            </div>
            ...
            <div class="flex items-center mb-3">
                ...
                <span class="text-xs text-gray-300">{{ $tweet->dislikes }}</span>
            </div>
        </div>
